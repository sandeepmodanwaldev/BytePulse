...
const AddToPlaylistModal = ({ isOpen, onClose, problemId }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-500/50 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white shadow-2xl  dark:bg-gray-900  broder brodar-gray-200 rounded-lg w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="form-control">
            ...
            <select
              className="select select-bordered w-full bg-white shadow-2xl  dark:bg-gray-900 rounded-lg broder brodar-gray-200"
