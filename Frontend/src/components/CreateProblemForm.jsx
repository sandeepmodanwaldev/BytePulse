...
import problemSchema from "../schemas/createProblemSchema";
...
const CreateProblemForm = () => {
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-7xl">
      <div className="card dark:bg-gray-900 dark:text-white shadow-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 font-inter">
                {tagFields.map((field, index) => (
                  <div key={field.id} className="flex gap-2 items-center">
                    <input
                      type="text"
                      className="input input-bordered flex-1 bg-white dark:bg-[#262d43] broder border-gray-300  shadow-2xl dark:border-gray-300"
                      {...register(`tags.${index}`)}
                  ...
                  >
                    <div className="card-body p-4 md:p-6">
                      <div className="flex justify-between items-center mb-4">
                        <h4 className="text-base-100 dark:text-white md:text-lg font-semibold">
                          Test Case #{index + 1}
                        </h4>
                        <button
                          type="button"
