  ...
  return (
    <>
      <div className="p- md:p-">
        <div className="grid grid-cols-1 md:grid-cols-2   borde border-gray-40 rounded-3xl p-6 md:p-10 shadow-md bg-white dark:bg-gray-900 dark:text-white">
          {/* Text Content */}
          <div className="text-base md:text-lg font-medium space-y-10 pt-5">
